...
public class AddProductUI {
    ...
    public void addProductUI() {
        ...
        BigDecimal newProductPrice = null;
        ProductCategory newProductCategory = productCategoryChoiseService.productCategoryIntChoice(0);
        BigDecimal newProductDiscount = null;
